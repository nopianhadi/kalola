...
const InvoiceDocument: React.FC<InvoiceDocumentProps> = ({
  ...
  const mainPackage = packages.find(p => String(p.id) === String(project.packageId) || p.name === project.packageName);
        ...
        <div className="flex flex-row justify-between items-start gap-4">
          ...
          <div className="text-right flex flex-col items-end shrink-0">
            ...
            <div className="bg-slate-200 px-3 py-1 rounded-sm text-[12px] font-bold text-slate-700 mb-2 print:bg-white print:border print:border-slate-300">
              ID: #INV-{String(project.id).padStart(4, '0')}
            </div>
      ...
      <div className="p-8 sm:p-10 space-y-8 print:p-0 print:pt-6">
        ...
        <div className="overflow-hidden">
          <table className="w-full text-left table-fixed">
            ...
            <tbody className="divide-y divide-slate-100 print:divide-slate-200 text-[13px]">
              ...
              {project.addOns && project.addOns.length > 0 && project.addOns.map((addon) => (
                <tr key={addon.id}>
              ...
              {project.customCosts && project.customCosts.length > 0 && project.customCosts.map((cost) => (
                <tr key={cost.id}>
                  <td className="px-4 py-3">
        ...
        <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-100 print:pt-4 print:border-slate-200">
          <div className="col-span-2">
            <p className="text-[9px] text-slate-400 text-center uppercase tracking-widest font-black mb-10">Dicetak Otomatis oleh Sistem  Weddfin</p>
          </div>
