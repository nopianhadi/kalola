...
describe('validateTerminologyConsistency', () => {
  it('returns success when no old terminology is found', () => {
    const fileContents = new Map([
      ...
      ['pages/projects/ProjectsPage.tsx', 'const title = "Detail Acara Pernikahan"; const progress = "Progres Pengerjaan Pengantin";']
    ]);
  ...
  it('validates all terminology changes are applied', () => {
    const fileContents = new Map([
      ...
      ['pages/projects/ProjectsPage.tsx', 'const detail = "Detail Acara Pernikahan"; const progress = "Progres Pengerjaan Pengantin";'],
