...
import { LightbulbIcon, ClockIcon, CheckSquareIcon, DollarSignIcon, LogOutIcon, WhatsappIcon } from '@/constants';
...
interface HeaderProps {
    ...
    handleNavigation: (view: ViewType, action?: NavigationAction, notificationId?: number | string) => void;
